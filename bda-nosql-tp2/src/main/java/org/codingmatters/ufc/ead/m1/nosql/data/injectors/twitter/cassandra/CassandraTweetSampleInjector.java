...
public class CassandraTweetSampleInjector {
    public static void main(String[] args) {
        ...
        client.execute("CREATE TABLE IF NOT EXISTS ufcead.tweets (tweetid text, username text, text text, createdAt timestamp, primary key (tweetid))");
        client.execute("CREATE TABLE IF NOT EXISTS ufcead. user_timeline (username text, createdAt timestamp, tweetid text, primary key (username, createdAt))");
        client.execute("CREATE TABLE IF NOT EXISTS ufcead. htag_timeline (htag text, createdAt timestamp, tweetid text, primary key (htag, createdAt));");
